    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Gostium") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gostium address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Gostium"), this);
    aboutAction->setStatusTip(tr("Show information about Gostium"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Gostium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gostium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gostium addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Gostium client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gostium network", "", count));
}
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-Gostium network", "", count));
}
...
{
    QString strTitle = tr("Gostium"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Gostium address or malformed URI parameters."),
